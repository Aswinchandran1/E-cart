...
const Footer = () => {
  return (
    <div style={{ height: '250px' }} className='mt-5 w-full p-6 text-white w-100 bg-violet-600'>
      <div className="flex justify-between items-center">
        {/* Intro */}
        <div style={{ width: '400px' }}>
          <h5><i className="fa-solid fa-music me-2"></i>E-Cart</h5>
      ...
      <p className='text-center mt-8'>Copyright &copy; 2024</p>
    </div>
