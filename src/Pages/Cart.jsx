          ...
          <div className="grid grid-cols-3 gap-4 mt-5">
              ...
              <table className='table-auto w-full'>
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>Hot wheels</td>
                    <td><img width={'70px'} height={'70px'} src="https://www.museumofplay.org/app/uploads/2021/08/Hot-wheels-sq.jpg" alt="" /></td>
                    <td>
                      <div className="flex">
                        <button className="font-bold">-</button>
                        <input style={{ width: '40px' }} type="text" className="p-3 border rounded mx-2" value={2} readOnly />
                        <button className="font-bold">+</button>
                      </div>
                    </td>
                    <td>$ 100</td>
            ...
            <div className="col-span-1">
              <div className="border rounded dhadow p-5">
                <h2 className="text-2xl font-bold my-4">Total Amount : <span className='text-red-600'>$ 99.99</span></h2>
                <hr />
